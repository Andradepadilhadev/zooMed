...
export class generateTables1667684699865 implements MigrationInterface {
    name = 'generateTables1667684699865'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "doctors_specialities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "doctorId" uuid, "specialityId" uuid, CONSTRAINT "PK_3a5c775e69ac1536debafbd8859" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "clinics_doctors" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "clinicId" uuid, "doctorId" uuid, CONSTRAINT "PK_c05a6638d7bb3eedd0576c0fea3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "appointments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "hour" TIME NOT NULL, "isCanceled" boolean NOT NULL DEFAULT false, "animalsId" uuid, "clinicsDoctorsId" uuid, CONSTRAINT "PK_4a437a9a27e948726b8bb3e36ad" PRIMARY KEY ("id"))`);
