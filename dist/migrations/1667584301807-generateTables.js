...
exports.generateTables1667584301807 = void 0;
class generateTables1667584301807 {
    constructor() {
        this.name = 'generateTables1667584301807';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE "appointments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "hour" TIME NOT NULL, "isCanceled" boolean NOT NULL DEFAULT false, "animalsId" uuid, "clinicsDoctorsIdId" uuid, CONSTRAINT "PK_4a437a9a27e948726b8bb3e36ad" PRIMARY KEY ("id"))`);
...
exports.generateTables1667584301807 = generateTables1667584301807;
