...
exports.allEntities1667325269284 = void 0;
class allEntities1667325269284 {
    constructor() {
        this.name = 'allEntities1667325269284';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE "doctors_specialities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "doctorIdId" uuid, "specialtyIdId" uuid, CONSTRAINT "PK_3a5c775e69ac1536debafbd8859" PRIMARY KEY ("id"))`);
            ...
            yield queryRunner.query(`CREATE TABLE "clinics_doctors" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "clinicIdId" uuid, "doctorIdId" uuid, CONSTRAINT "PK_c05a6638d7bb3eedd0576c0fea3" PRIMARY KEY ("id"))`);
            yield queryRunner.query(`CREATE TABLE "appointments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "hour" TIME NOT NULL, "animalsId" uuid, "clinicsDoctorsIdId" uuid, CONSTRAINT "PK_4a437a9a27e948726b8bb3e36ad" PRIMARY KEY ("id"))`);
            ...
            yield queryRunner.query(`CREATE TABLE "animals" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "birthDate" TIMESTAMP NOT NULL, "breed" character varying(200) NOT NULL, "userId" uuid, "speciesId" uuid, CONSTRAINT "PK_6154c334bbb19186788468bce5c" PRIMARY KEY ("id"))`);
            ...
            yield queryRunner.query(`ALTER TABLE "doctors_specialities" ADD CONSTRAINT "FK_66970d7bd7c558ef1cb6dd05b06" FOREIGN KEY ("doctorIdId") REFERENCES "doctors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            yield queryRunner.query(`ALTER TABLE "doctors_specialities" ADD CONSTRAINT "FK_4cf258623feb0415058ecf4e9bf" FOREIGN KEY ("specialtyIdId") REFERENCES "specialities"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            yield queryRunner.query(`ALTER TABLE "clinics_doctors" ADD CONSTRAINT "FK_04fba043059c7f5ba6462346f10" FOREIGN KEY ("clinicIdId") REFERENCES "clinics"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            yield queryRunner.query(`ALTER TABLE "clinics_doctors" ADD CONSTRAINT "FK_5c764d1aaa2c7ad2ad41f332b34" FOREIGN KEY ("doctorIdId") REFERENCES "doctors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            ...
            yield queryRunner.query(`ALTER TABLE "appointments" ADD CONSTRAINT "FK_1be3864ef1ea077611b6aaddc5f" FOREIGN KEY ("clinicsDoctorsIdId") REFERENCES "clinics_doctors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`ALTER TABLE "appointments" DROP CONSTRAINT "FK_1be3864ef1ea077611b6aaddc5f"`);
            yield queryRunner.query(`ALTER TABLE "appointments" DROP CONSTRAINT "FK_bc5bef9b84ffd3fd8cad401b5b0"`);
            yield queryRunner.query(`ALTER TABLE "clinics_doctors" DROP CONSTRAINT "FK_5c764d1aaa2c7ad2ad41f332b34"`);
            yield queryRunner.query(`ALTER TABLE "clinics_doctors" DROP CONSTRAINT "FK_04fba043059c7f5ba6462346f10"`);
            yield queryRunner.query(`ALTER TABLE "doctors_specialities" DROP CONSTRAINT "FK_4cf258623feb0415058ecf4e9bf"`);
            yield queryRunner.query(`ALTER TABLE "doctors_specialities" DROP CONSTRAINT "FK_66970d7bd7c558ef1cb6dd05b06"`);
...
exports.allEntities1667325269284 = allEntities1667325269284;
