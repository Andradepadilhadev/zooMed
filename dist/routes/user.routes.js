...
const userRoutes = () => {
    ...
    routes.patch("", ensureAuthToken_middleware_1.default, user_cotroller_1.deleteUserController);
    routes.patch("", ensureAuthToken_middleware_1.default, ensureForbiddenFieldsMiddleware_1.default, user_cotroller_1.updateUserController);
    ...
    routes.patch("/appointments/:id", ensureAuthToken_middleware_1.default, user_cotroller_1.deleteUserAppointmentsController);
